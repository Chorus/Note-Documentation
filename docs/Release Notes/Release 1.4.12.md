...
- **[Clone Targets](../CarePlan/ConfigureTargets.md/#clone-a-target)!** Open any target and press the ⫶ icon to choose how many copies of the target you’d like. Targets will be cloned with all configurations and parented under the same domain, subdomain, and goal.
