...
- Check that you are using the most updated version of the app (2.1.2).
...
If sync support is needed, reach out to help@chorus.cloud. To avoid losing local data, do not delete the app if the app has not synced recently. Follow the steps below if support requests your database to preserve unsynced data so you can reinstall the app: 
...
5. You can then attach the database in an email to help@chorus.cloud, or [upload it here](https://chorusdevs2.sharepoint.com/:f:/s/DatabaseImports/EneKTBp-qrFLvfKsMshoCHQBflMnNtNIzZ2xmnfdldYccQ?e=eP9HW1 "Upload DB").
