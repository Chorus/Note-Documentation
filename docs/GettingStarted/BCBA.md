...
**Care Plan**
- [Default Configuration](../CarePlan/AddGoalsTargets.md/#default-configuration) - Learn how to share target configurations between learners- configure once, reuse as needed!
